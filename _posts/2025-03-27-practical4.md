...
Go through Advanced Aggregation Features topic given in the textbook Database Sytems Concepts( Chapter 5 Advanced SQL -  Advanced Aggregate Features Page 219)
Create notes on 
- Ranking
- Windowing
- Pivoting
...
## Task 1: Create a schema in your database called voting 
## Task 2: Create the database for the schema voting using the above given voter registration system
## Task 3: Load dummy data on the database
## Task 4: Grant priviledges to voters to view the details of political parties, voters cannot modify the details in the political_party table
## Task 3: Perform at least one example query on the database for each of the above given advanced aggregate features(Ranking, Windoing, Pivoting, Rollup, Cube)
